...
make_plot(
  file_names = file.path(output_dir, c(
    "trep_brdU_mean_per_read_IDS_43-R10-ASM294v2.txt",
    "trep_brdU_mean_per_read_IDS_47-R10-ASM294v2.txt")),
  labels = c("0.5 uM BrdU (IDS_43)", "2 uM BrdU (IDS_47)"),
  output_file = "Supp_Fig2A_top.svg",
  facet_labels = c(
...
make_plot(
  file_names = file.path(output_dir, c(
    "trep_brdU_mean_per_read_IDS_52-R10-ASM294v2.txt",
    "trep_brdU_mean_per_read_IDS_65-R10-ASM294v2.txt")),
  labels = c("2 uM BrdU (IDS_52)", "4 uM BrdU (IDS_65)"),
  output_file = "Supp_Fig2A_bottom.svg",
  facet_labels = c(
