...
# Usage: bash Supp_Fig2A_brdU_fraction_over_replication_time.sh /path/to/input_dir /path/to/output_dir
...
Rscript ./plot_brdU_fraction_over_replication_time_Supp_Fig2A.R "$output_dir"
